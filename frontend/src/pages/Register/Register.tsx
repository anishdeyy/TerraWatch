...
import { Globe, Lock, Mail, User as UserIcon, ArrowRight, Shield, AlertCircle, Loader2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-3xl border border-slate-200 p-8 shadow-xl">
        <div className="text-center mb-6">
          ...
          <h2 className="text-xl font-bold text-slate-900">Create Platform Account</h2>
          <p className="text-xs text-slate-500 mt-1">Join the Geospatial Environmental Intelligence Network</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="analyst@demo.terrawatch.earth"
                className="w-full pl-10 pr-3.5 py-2.5 bg-slate-50 border border-slate-300 rounded-xl text-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-700"
              />
            </div>
          </div>
          ...
          <div>
            ...
            >
              <option value="ANALYST">Environmental Analyst</option>
              <option value="VIEWER">Project Stakeholder / Viewer</option>
              <option value="ADMIN">Project Developer / Admin</option>
            </select>
          </div>
